...
@media (max-width:640px){
  .ap-nav{padding:10px 14px!important}
  .ap-nav-brand{font-size:17px!important;gap:6px!important}
  .ap-nav-logo{width:30px!important;height:30px!important}
  .ap-nav-badge{display:none!important}
  .ap-nav-track-text{display:none!important}
  .ap-nav-track-btn{padding:8px 10px!important}
  .ap-hero{padding:36px 16px 32px!important}
  .ap-hero-badge{font-size:11px!important;padding:6px 12px!important}
  .ap-hero-sub{font-size:14px!important}
  .ap-hero-chips{gap:6px!important}
  .ap-hero-chip{font-size:11px!important;padding:6px 12px!important}
  .ap-hero-buttons{flex-direction:column!important;width:100%!important}
  .ap-hero-buttons button{width:100%!important;justify-content:center!important}
  .ap-section{padding:0 14px!important}
  .ap-card{padding:20px!important}
  .ap-stats-bar{grid-template-columns:repeat(2,1fr)!important}
  .ap-stats-bar>div{border-right:none!important;border-bottom:1px solid #F1F5F9;padding:14px 4px!important}
  .ap-cta-grid{grid-template-columns:1fr!important}
  .ap-cta-stats{grid-template-columns:repeat(3,1fr)!important;gap:8px!important}
  .ap-appid{font-size:22px!important;letter-spacing:1px!important;word-break:break-all}
  .ap-admin-table-row{grid-template-columns:1fr 1fr!important;row-gap:6px!important;font-size:12px!important}
  .ap-admin-table-row>*:nth-child(n+5){display:none!important}
  .ap-admin-header{display:none!important}
  .ap-modal{padding:18px!important;max-width:94vw!important}
  .ap-modal-grid{grid-template-columns:1fr!important}
  .ap-modal-actions{flex-direction:column!important}
  .ap-status-input-row{flex-direction:column!important}
  .ap-status-input-row button{width:100%!important}
...
`}</style>
            ...
            <div style={{marginBottom:16}}>
              ...
              <div className="ap-status-input-row" style={{display:"flex",gap:10}}>
                <input
                  ...
                  style={{...inp,flex:1,textTransform:"uppercase",letterSpacing:1,fontWeight:600,minWidth:0}}
                  placeholder="AP-2025-XXXX"
                />
                <button onClick={checkStatus} disabled={statusLoading} style={B({background:"linear-gradient(135deg,#0D9488,#0F766E)",color:"#FFF",padding:"13px 20px",fontSize:14,borderRadius:10,opacity:statusLoading?.7:1,flexShrink:0})}>
                  {statusLoading?"...":"Check"}
                </button>
              </div>
            </div>
                ...
                <div style={{marginTop:8}}>
                  ...
                  <div className="ap-modal-grid" style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:12}}>
                    {[
                      ...
                      <div key={k} style={{background:"#F8FAFC",borderRadius:10,padding:"12px 14px",minWidth:0}}>
        ...
        <div className="ap-section" style={{maxWidth:520,margin:"0 auto",padding:"50px 24px 100px"}}>
          ...
          <div className="ap-card" style={{background:"#FFF",border:"1px solid #E2E8F0",borderRadius:18,padding:28,boxShadow:"0 4px 16px rgba(0,0,0,.05)"}}>
            ...
            <div style={{background:"#F8FAFC",border:"1px solid #E2E8F0",borderRadius:14,padding:20,marginBottom:16}}>
              <div className="ap-payment-grid" style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:16}}>
                <div style={{minWidth:0}}>
                  <div style={{fontSize:10,color:"#94A3B8",fontWeight:600,marginBottom:4,letterSpacing:.5}}>JAZZCASH NUMBER</div>
                  <div style={{fontSize:18,fontWeight:800,color:"#0F172A",letterSpacing:1,wordBreak:"break-word"}}>{JAZZCASH}</div>
                </div>
                <div style={{minWidth:0}}>
                  <div style={{fontSize:10,color:"#94A3B8",fontWeight:600,marginBottom:4,letterSpacing:.5}}>ACCOUNT TITLE</div>
                  <div style={{fontSize:14,fontWeight:600,color:"#0F172A",wordBreak:"break-word"}}>{Shahnawaz}</div>
                </div>
                <div style={{minWidth:0}}>
      ...
      {view==="done"&&(
        <div className="ap-section" style={{maxWidth:520,margin:"0 auto",padding:"70px 24px 100px",textAlign:"center"}}>
          ...
          <h2 style={{fontSize:"clamp(22px,5vw,26px)",fontWeight:800,marginBottom:8,color:"#0F172A"}}>You're All Set!</h2>
            ...
            {loading?(
              ...
              <div style={{background:"#FFF",border:"1px solid #E2E8F0",borderRadius:16,overflow:"hidden",boxShadow:"0 2px 8px rgba(0,0,0,.04)"}}>
                ...
                {apps.map((a,i)=>{
                  ...
                  return(
                    <div key={a.id} className="ap-admin-table-row" onClick={()=>setSel(a)}
      ...
      {sel&&view==="admin"&&authUser&&(
        <div onClick={()=>setSel(null)} style={{position:"fixed",inset:0,background:"rgba(15,23,42,.5)",backdropFilter:"blur(6px)",display:"flex",alignItems:"center",justifyContent:"center",padding:20,zIndex:50}}>
          <div className="ap-modal" onClick={e=>e.stopPropagation()} style={{background:"#FFF",borderRadius:20,padding:28,maxWidth:540,width:"100%",boxShadow:"0 25px 60px rgba(0,0,0,.2)",maxHeight:"90vh",overflowY:"auto"}}>
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"start",marginBottom:20,gap:10}}>
              <div style={{display:"flex",alignItems:"center",gap:12,minWidth:0}}>
                <div style={{width:46,height:46,borderRadius:"50%",background:"linear-gradient(135deg,#0D9488,#14B8A6)",color:"#FFF",display:"flex",alignItems:"center",justifyContent:"center",fontWeight:700,fontSize:18,flexShrink:0}}>{sel.fullName?.[0]}</div>
                <div style={{minWidth:0}}>
              ...
              <X size={20} color="#9CA3AF" style={{cursor:"pointer",flexShrink:0}} onClick={()=>setSel(null)}/>
            </div>
            ...
            <div className="ap-modal-grid" style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:12,fontSize:14,marginBottom:16,background:"#F8FAFC",borderRadius:14,padding:20}}>
              {[
                ...
                <div key={k} style={{minWidth:0}}>
                  ...
                  <div style={{fontWeight:600,color:"#0F172A",fontSize:13,wordBreak:"break-word"}}>{v}</div>
                </div>
              ))}
            </div>
